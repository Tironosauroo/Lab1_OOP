...
**State Machine Diagram:** Описує реактивну поведінку контролера гравця, зміну складних (вкладених) станів руху та присідання у відповідь на події системи вводу.
